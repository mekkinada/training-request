                            ...
                            <Table>
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell>Rating <Button onClick={this.sortByRating}>{this.renderRatingIcon()}</Button></TableCell>
                                        <TableCell> Title <Button onClick={this.sortByTitle}>{this.renderTitleIcon()}</Button></TableCell>
